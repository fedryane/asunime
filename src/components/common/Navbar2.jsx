  ...
  return (
    <div className="relative">
      <nav
        className={
          changeColor
            ? "w-full fixed top-0 left-0 right-0 bg-[#141414] text-white transition duration-300 z-20 opacity-80"
            : "w-full bg-transparent text-white transition duration-500 z-20 "
        }
      >
